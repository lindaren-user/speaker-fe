    ...
    >
      <div class="thumbnail">
        ...
        <div v-if="hoverId === video.id" class="overlay">
          <button
            style="border-radius: 50%;border-width: 1px;border-color: red;width: 50px;height: 50px;"
            @click.stop="emit('delete-video', video.id)"
          >
            <i class="iconfont icon-shanchu1" style="color: red;font-size: 28px; cursor: pointer;"></i>
          </button>
        </div>
